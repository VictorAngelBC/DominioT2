...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  private FragmentRegisterBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnRegistrarse, @NonNull EditText etContra, @NonNull EditText etCorreo,
      @NonNull EditText etNombre, @NonNull TextView tvTitle) {
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRegisterBinding((ConstraintLayout) rootView, btnRegistrarse, etContra,
          etCorreo, etNombre, tvTitle);
    }
